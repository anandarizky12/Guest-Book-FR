...
function VisitPurposePrint({ guest, filter, activePage }) {
    return (
        ...
        <header className='text-sm'>DATA TUJUAN KUNJUNGAN TAMU PADA BADAN PUSAT STATISTIK KOTA BANJARMASIN</header>
...
export default VisitPurposePrint
