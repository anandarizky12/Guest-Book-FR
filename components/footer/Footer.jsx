    ...
    >
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center text-gray-400 text-sm justify-center">
          <a className="pr-3">Sensus Penduduk</a>
          <a className="border-l border-gray-400 px-3">Sensus Pertanian</a>
          <a className="border-l border-gray-400 pl-3">Sensus Ekonomi</a>
        </div>
        <div className="text-center text-white">
          ...
          <div className="py-3 tracking-wide">
            <p>
              Badan Pusat Statistik{" "}
              <span className="font-light"> - Kota Banjarmasin</span>
            </p>
          </div>
        </div>
      </div>
