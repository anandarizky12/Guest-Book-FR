          ...
          <form onSubmit={(e)=>handleSubmit(e)}>
              ...
              <div className="w-full lg:w-full px-4">
                <div className="relative w-full">
                  ...
                  <div className="my-5">
                      <label htmlFor="file-upload" className="bg-red-500 text-xs md:text-sm cursor-pointer py-2 px-5 font-semibold text-gray-100 rounded-md">
                          Unggah Gambar
                      </label>
                      <label className="hidden md:inline-block text-xs md:text-sm text-gray-500 ml-2">Pilih Gambar Dari Komputer</label>
                      <input onChange={uploadImage} id="file-upload" type="file" hidden/>
                  </div>
