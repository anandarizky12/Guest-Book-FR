          ...
          <div className="font-sans relative border border-gray-200 flex flex-col break-words w-full mb-6 shadow-lg rounded-lg ">
            <div className="rounded-t mb-0 px-4 lg:px-9 py-6 flex justify-between">
              <div className="text-center flex justify-between">
                <h6 className="text-blue-700 text-sm md:text-2xl font-semibold">
                  Masukan Data Anda
                </h6>
              </div>
              ...
              <div
                onClick={() => Router.push("/")}
                className="cursor-pointer text-center flex justify-between items-center"
              >
                <FaArrowLeft className="text-gray-400 mr-2" />
                <h6 className="text-gray-400 text-sm md:text-xl font-semibold">
                  Kembali
                </h6>
              </div>
            </div>
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0 bg-white">
              <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="flex flex-wrap">
                  ...
                  <div className="w-full lg:w-6/12 px-4">
                    ...
                    <div className="relative w-3/6 mb-3 flex  flex-wrap justify-between">
                      <div className="">
                        <input
                          checked={state.gender == "Laki-Laki" ? true : false}
                          onChange={(e) => handleInput(e)}
                          type="radio"
                          id="Laki-Laki"
                          name="gender"
                        ...
                        />
                        <label
                          className="font-light ml-2 text-xs md:text-sm"
                          htmlFor="Laki-Laki"
                        >
                          Laki - Laki
                        </label>
                      ...
                      <div className="">
                        <input
                          checked={state.gender == "Perempuan" ? true : false}
                          onChange={(e) => handleInput(e)}
                          type="radio"
                          id="Perempuan"
                          name="gender"
                    ...
                    focus:text-gray-500 focus:bg-white focus:border-blue-600 focus:outline-none"
                      ...
                      >
                        <option
                          value={null}
                          disabled
                          selected={state.instance ? false : true}
                        >
                          -- Klik Untuk Pilih Instansi --
                        </option>
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-blue-500 w-20 text-white active:bg-gray-500 font-semibold text-xs md:text-base px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-4 mb-1 ease-linear transition-all duration-150"
                  >
