        ...
        <div className="font-sans relative border border-gray-200 flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg ">
          <div className="rounded-t bg-white mb-0 px-6 py-6">
            <div className="text-center flex justify-between">
              <h6 className="text-gray-500 text-sm md:text-2xl font-semibold">
                Edit Data Tamu
              </h6>
            </div>
          </div>
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    >
                      ...
                      {instance_data.data.instance.map((item, index) => {
                        return (
                          <option
                            selected={
                              state.instance && state.instance._id == item._id
                            }
                            key={index}
                            value={item._id}
                          >
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="bg-green-500 w-20 text-white active:bg-gray-500 font-bold uppercase text-xs md:text-base px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                >
