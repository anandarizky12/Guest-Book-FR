        ...
        <div className="min-w-full overflow-x-auto bg-white shadow-md rounded my-6">
          <table className="min-w-full border-collapse table-fixed">
            ...
            <tbody className="text-gray-600 text-sm font-light">
              {guest &&
                paginationData(
                  getFilteredByTime(guest.guest, filter),
                  activePage,
                  10
                ).map((guest, index) => (
                  <tr
                  ...
                  >
                    ...
                    <td className="py-3 px-6 text-center">
                      <div className="flex item-center justify-center">
                        <div
                          onClick={() =>
                            router.push(`detailguest/${guest._id}`)
                          }
                          className="w-4 mr-2 text-green-500 transform hover:text-purple-500 hover:scale-110"
                        >
                          <FaEye />
                        </div>
                        <div
                          onClick={() => router.push(`editguest/${guest._id}`)}
                          className="w-4 mr-2 text-yellow-500 transform hover:text-purple-500 hover:scale-110"
                        >
                          <svg
                        ...
                        <div
                          onClick={() => handleDelete(dispatch, guest._id)}
                          className="w-4 mr-2 text-red-600 transform hover:text-purple-500 hover:scale-110"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
